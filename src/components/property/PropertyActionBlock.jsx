        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.01] border border-white/[0.04]">
          ...
          <div>
            <h4 className="text-sm font-bold text-slate-200">
              {property.ownerName || "Premium Landlord"}
            </h4>
            <p className="text-[11px] text-slate-400 flex items-center gap-1 mt-0.5">
              <MessageSquare size={12} className="text-purple-400" /> Responses
              within 1 hour
            </p>
          </div>
        </div>
            ...
            <Modal.Container placement="center" className="max-w-md mx-4">
              <Modal.Dialog className="bg-[#111622] border border-white/[0.06] text-white rounded-3xl p-6 shadow-[0_25px_50px_rgba(0,0,0,0.5)]">
                ...
                <Modal.Header className="border-b border-white/[0.05] pb-4 text-left">
                  <Modal.Heading className="text-xl font-extrabold text-white tracking-tight">
                    Confirm Booking
                  </Modal.Heading>
                  <p className="text-xs text-slate-400 mt-1 font-light">
                    Provide credentials to secure your tenancy placement. Once
                    confirmed, you can track it under{" "}
                  ...
                  >
                    ...
                    >
                      <Label className="text-xs text-slate-400 font-semibold flex items-center gap-1.5 uppercase tracking-wider">
                        <Calendar size={13} className="text-cyan-400" /> Move-in
                        Date *
                      </Label>
                      <Input
                        type="date"
                    ...
                    >
                      <Label className="text-xs text-slate-400 font-semibold flex items-center gap-1.5 uppercase tracking-wider">
                        <Phone size={13} className="text-cyan-400" /> Contact
                        Number *
                      </Label>
                      <Input
                        type="tel"
                    ...
                    <div className="border-t border-white/[0.05] pt-4 flex items-center justify-end gap-3 mt-2">
                      <Button
                        slot="close"
                        variant="secondary"
                        className="px-4 py-2 bg-white/[0.03] hover:bg-white/[0.06] text-slate-300 font-medium rounded-xl text-xs cursor-pointer"
                      >
                        Cancel
                      </Button>
                      <Button
        ...
        <button
          ...
          className={`w-full h-11 border text-xs font-semibold rounded-xl tracking-wide transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer ${
            isFavorite
              ...
              : "bg-white/1 border-white/6 text-slate-300 hover:border-pink-500/30 hover:text-pink-400"
          }`}
        >
          <Heart
            size={14}
            className={
              isFavorite ? "fill-pink-500 stroke-pink-500" : "stroke-slate-400"
            }
          />
